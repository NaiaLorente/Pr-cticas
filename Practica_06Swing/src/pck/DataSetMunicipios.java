...
public class DataSetMunicipios {
	...
	private List<String> lAutonomias = new ArrayList<String>();
	...
	public DataSetMunicipios( String nombreFichero ) throws IOException {
		...
		while (lecturaFic.hasNextLine()) {
			...
			try {
				...
				lAutonomias.add(comunidad);
				int poblacion=Integer.parseInt(partes[5]);
				
				Municipio muni = new Municipio( codigo, nombre, habitantes, provincia, comunidad,poblacion );
